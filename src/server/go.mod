...
require (
	...
	github.com/quollix/taskrunner v1.2.3 // indirect
...
// TODO to be updated, when rod supports the latest API version of this, see https://github.com/go-rod/rod/issues/1203

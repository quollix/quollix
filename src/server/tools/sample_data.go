...
const (
  ...
  sampleapp:
    ...
    environment:
      ...
      - SECRET_SAMPLE_VERSION_ZERO=${SECRET_SAMPLE_VERSION_ZERO}
...
`
  ...
  sampleapp:
    ...
    environment:
      ...
      - APP_SECRET=${APP_SECRET}
      - SECRET_SAMPLE_SHARED=${SECRET_SAMPLE_SHARED}
      - SECRET_SAMPLE_VERSION_ONE=${SECRET_SAMPLE_VERSION_ONE}
      - SAMPLE_LEGACY_PASSWORD=password
      - IANA_TIMEZONE=${IANA_TIMEZONE}
      - PORT=3000
    volumes:
...
`
  ...
  sampleapp:
    ...
    environment:
      ...
      - APP_SECRET=${APP_SECRET}
      - SECRET_SAMPLE_SHARED=${SECRET_SAMPLE_SHARED}
      - SECRET_SAMPLE_VERSION_TWO=${SECRET_SAMPLE_VERSION_TWO}
      - SAMPLE_LEGACY_PASSWORD=${SECRET_SAMPLE_MIGRATED_PASSWORD}
      - IANA_TIMEZONE=${IANA_TIMEZONE}
      - PORT=3001
    volumes:
      - samplemaintainer_sampleapp_data:/data

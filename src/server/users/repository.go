...
var (
	...
	userInsert = fmt.Sprintf(`INSERT INTO users (%s) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING user_id`, userColumnsNoId)
	userUpdate = fmt.Sprintf(`UPDATE users SET (%s) = ($2, $3, $4, $5, $6, $7, $8) WHERE user_id = $1`, userColumnsNoId)
)

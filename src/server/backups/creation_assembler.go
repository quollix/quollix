...
func (a *BackupCreationAssemblerImpl) BuildBackupCreation(app *apps_basic.RepoApp, description string) (BackupCreationDto, []string, *MetaData) {
	...
	meta := NewMetaData(app.ClientId, app.ClientSecret, app.AppSecret, app.AccessPolicy, app.Port, app.VersionCreationTimestamp, app.AutomaticUpdatesEnabled, app.AutomaticBackupsEnabled, app.Secrets)

...
func TestGroupsPageCreateAndDeleteGroup(t *testing.T) {
	...
	groupsPage := frame.Pages.OpenGroupsPage()
...
func TestGroupMembersPageMembershipFlow(t *testing.T) {
	...
	groupMembersPage = frame.Pages.OpenGroupsPage().OpenGroupMembersPage(sampleGroupName)
...
func TestGroupAppsPageAccessFlow(t *testing.T) {
	...
	groupAppsPage = frame.Pages.OpenGroupsPage().OpenGroupAppsPage(sampleGroupName)

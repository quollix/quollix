...
func TestPublicPolicyAllowed(t *testing.T) {
	...
	err := authorizer.Authorize(api.Policies.PublicAccessPolicy, tools.AnonymousLevel, users.AnonymousUserId, sampleAppName)
	assert.Nil(t, err)
}
...
func TestAuthenticatedPolicyAnonymousDenied(t *testing.T) {
	...
	err := authorizer.Authorize(api.Policies.AuthenticatedAccessPolicy, tools.AnonymousLevel, users.AnonymousUserId, sampleAppName)
...
func TestAuthenticatedPolicyUserAllowed(t *testing.T) {
	...
	err := authorizer.Authorize(api.Policies.AuthenticatedAccessPolicy, tools.UserLevel, sampleUserId, sampleAppName)
	assert.Nil(t, err)
}
...
func TestAdminOnlyPolicyAdminAllowed(t *testing.T) {
	...
	err := authorizer.Authorize(api.Policies.AdminOnlyAccessPolicy, tools.AdminLevel, sampleUserId, sampleAppName)
	assert.Nil(t, err)
}
...
func TestAdminOnlyPolicyUserDenied(t *testing.T) {
	...
	err := authorizer.Authorize(api.Policies.AdminOnlyAccessPolicy, tools.AnonymousLevel, sampleUserId, sampleAppName)
	assert.Equal(t, AccessDeniedError, u.ExtractError(err))

	err = authorizer.Authorize(api.Policies.AdminOnlyAccessPolicy, tools.UserLevel, sampleUserId, sampleAppName)
	assert.Equal(t, AccessDeniedError, u.ExtractError(err))
}
...
func TestGroupRestrictedPolicyAdminAllowed(t *testing.T) {
	...
	err := authorizer.Authorize(api.Policies.GroupRestrictedAccessPolicy, tools.AdminLevel, sampleUserId, sampleAppName)
	assert.Nil(t, err)
}
...
func TestGroupRestrictedPolicyAnonymousUserIdDenied(t *testing.T) {
	...
	err := authorizer.Authorize(api.Policies.GroupRestrictedAccessPolicy, tools.UserLevel, users.AnonymousUserId, sampleAppName)
	assert.Equal(t, AccessDeniedError, u.ExtractError(err))
}
...
func TestGroupRestrictedPolicyHasAccessAllowed(t *testing.T) {
	...
	err := authorizer.Authorize(api.Policies.GroupRestrictedAccessPolicy, tools.UserLevel, sampleUserId, sampleAppName)
	assert.Nil(t, err)
}

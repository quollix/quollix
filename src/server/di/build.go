...
var SharedSet = wire.NewSet(
	...
	wire.Struct(new(apps_basic.AppRequestResolverImpl), "*"),
	...
	wire.Struct(new(apps_basic.ComposeSecretExtractorImpl), "*"),
	...
	wire.Bind(new(apps_basic.ComposeSecretExtractor), new(*apps_basic.ComposeSecretExtractorImpl)),
	...
	wire.Bind(new(apps_basic.AppRequestResolver), new(*apps_basic.AppRequestResolverImpl)),
